...
#         )
#     return ""  # Chat mode — no special instructions
#
...
#
#     with col_a:
#         pdf_mode = st.toggle("Switch to PDF", value=False)
#
#     with col_b:
#         if "provider" not in st.session_state:
#             st.session_state["provider"] = "OpenAI"
#
#         use_deepseek = st.toggle("Use DeepSeek", value=(st.session_state["provider"] == "DeepSeek"))
#
#         # Update provider based on toggle state
...
#             """
#             <style>
#             /* Hide the empty label container */
...
#
#             st.success("PDF uploaded and read by AIPA.")
#
#         elif uploaded_file is None:
#             # Clear stored PDF data when no file is uploaded
...
#
#     # Chat input field
#     # Chat mode selection (above input)
#     chat_mode = st.radio(
#         "Chat Mode:",
#         ["Chatty", "Coder", "Pro "],
#         index=2,
...
#
#     # Inject CSS to force scroll position to the top
#     st.markdown(
#         """
#         <style>
#             /* Target the vertical block containing your chat container */
#             section[data-testid="stVerticalBlock"] {
#                 display: flex;
#                 flex-direction: column-reverse; /* Ensures content renders top-first */
#                 overflow-y: auto;
#             }
#         </style>
#         """,
